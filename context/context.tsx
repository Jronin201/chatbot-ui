...
interface ChatbotUIContext {
  ...
  setSelectedWorkspace: Dispatch<SetStateAction<Tables<"public", "workspaces"> | null>>
  workspaceImages: WorkspaceImage[]
  setWorkspaceImages: Dispatch<SetStateAction<WorkspaceImage[]>>

  // PRESET STORE
  selectedPreset: Tables<"public", "presets"> | null
  setSelectedPreset: Dispatch<SetStateAction<Tables<"public", "presets"> | null>>

  // ASSISTANT STORE
  selectedAssistant: Tables<"public", "assistants"> | null
  setSelectedAssistant: Dispatch<SetStateAction<Tables<"public", "assistants"> | null>>
