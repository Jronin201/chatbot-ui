...
export const SidebarUpdateItem: FC<SidebarUpdateItemProps> = ({
  ...
  const updateFunctions = {
    chats: updateChat,
    presets: async (presetId: string, updateState: TablesUpdate<"public", "presets">) => {
    ...
    prompts: async (promptId: string, updateState: TablesUpdate<"public", "prompts">) => {
    ...
    files: async (fileId: string, updateState: TablesUpdate<"public", "files">) => {
    ...
    tools: async (toolId: string, updateState: TablesUpdate<"public", "tools">) => {
    ...
    models: async (modelId: string, updateState: TablesUpdate<"public", "models">) => {
